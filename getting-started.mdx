...
<Columns cols={2}>
  <Card title="Get started" icon="rocket" href="/get-set-up-with-bridge" cta="Get up and running with our API in minutes.">
    Use our virtual accounts to collect USD using account & routing numbers.
  </Card>
  <Card title="Guides" icon="money-bill-transfer" href="/get-started/movemoney/virtualaccounts" cta="Explore starter core use cases for moving money using orchestration, wallets, cards, and more.">
    Walk through setting up and sending payments using the API.
  </Card>
  <Card title="Developer Platform" icon="layer-group" iconType="regular" href="/customers/overview" cta="More detailed documentation on the developer platform.">
    More detailed documentation about the developer platform.
  </Card>
  <Card title="API Reference" icon="code" href="/api-reference">
    Detailed endpoint documentation with request/response schemas.
  </Card>
  <Card title="Changelog" icon="calendar" href="/changelog" cta="Read more about recent feature improvements and launches.">
