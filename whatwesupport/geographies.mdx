...
For customers in some European countries, we require proof of address. Refer [<u>Proof of Address Requirements</u>](https://apidocs.bridge.xyz/docs/proof-of-address-requirements)<u> [todo update link]</u> for the list of countries.