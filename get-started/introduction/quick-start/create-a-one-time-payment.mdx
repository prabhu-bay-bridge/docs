...
For detailed information, see [Transfers](/platform/orchestration/transfers/transfer).
...
View the full breakdown of transfer states [here](/platform/orchestration/transfers/transfer-states).
...
You can set up webhooks to receive real-time notifications about transfer status changes. See [guide](/get-started/introduction/quick-start/setting-up-webhooks) for more details on setting up webhooks.
...
- [Make recurring payments using saved payment routes](/get-started/guides/move-money/recurring)
