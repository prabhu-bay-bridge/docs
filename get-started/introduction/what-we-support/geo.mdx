...
For customers in some European countries, we require proof of address. Refer [Proof of Address Requirements](/platform/customers/compliance/poa) for the list of countries.