...
<Tip>
  **Highly advised. **We recommend using a flexible amounts to avoid payment validation failures.
</Tip>
...
<Tip>
  **Highly advised. **We recommend using this feature especially for crypto deposits. If your customer sends funds from an exchange, they won't be able to control the sending address.
</Tip>
