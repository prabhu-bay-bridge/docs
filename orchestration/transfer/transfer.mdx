...
- [<u>Stablecoins and Blockchains</u>](https://apidocs.bridge.xyz/docs/blockchains)<u> [todo update link]</u>
- [<u>Fiat Payment Methods</u>](https://apidocs.bridge.xyz/docs/payment-methods)<u> [todo update link]</u>
...
If you receive crypto deposits, remember to configure a crypto return policy\! Refer [<u>Crypto Return Policies</u>](https://apidocs.bridge.xyz/reference/crypto-return-policies) [todo update link]
