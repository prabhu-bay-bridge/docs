...
- [<u>Stablecoins and Blockchains</u>](/whatwesupport/chains)
- [<u>Fiat Payment Methods</u>](/whatwesupport/fiats)
...
- `developer_fee` or `developer_fee_percent`: Monetize transfers via fixed or percentage fees. Refer the [<u>Developer Fees</u>](/fees/devfees) section on how to set fees.
...
If you receive crypto deposits, remember to configure a crypto return policy\! Refer [<u>Crypto Return Policies</u>](/orchestration/transfer/returns#returning-crypto-deposits)
