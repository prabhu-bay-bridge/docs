---
title: "Onramp stablecoins using Bridge Wallet & Virtual Account"
---
...
:bulb:Use the bridge_wallet_id (wallet_abc123 above) when referencing the wallet in other Bridge APIs.
