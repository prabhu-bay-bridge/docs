...
<Steps>
  <Step title="Step 1: Create a KYC Link">
  ...
  <Step title="Step 2: Share the Links with Your Customer">
...
<Steps>
  <Step title="Step 1: Create an Individual Customer Using API">
  ...
  <Step title="Step 2: Customer Endorsements: Enabling Transacting">
