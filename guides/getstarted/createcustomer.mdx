...
<Steps>
  <Step title="Step 1: Create a KYC Link" titleSize="h2">
  ...
  <Step title="Step 2: Share the Links with Your Customer" titleSize="h2">
...
<Steps>
  <Step title="Step 1: Create an Individual Customer Using API" titleSize="h2">
  ...
  <Step title="Step 2: Customer Endorsements: Enabling Transacting" titleSize="h2">
...
3. **Set up webhooks** to receive real-time status updates for customers
   1. See [Setting up webhooks](/guides/getstarted/setupwebhooks) for setting up your first webhook
