...
A**static template transfer**  is a saved/reusable payment route let you generate reusable deposit instructions (like an ACH memo) that trigger a transfer automatically when funds are sent to Bridge.
