...
👉 Note: Customers must be onboarded and KYC/KYB-approved before creating virtual accounts.
...
To see the full breakdown of VirtualAccountEvents and their payloads, refer [Virtual Accounts](doc:virtual-accounts).
...
Refer [Virtual Accounts](doc:virtual-accounts) for more detailed documentation.