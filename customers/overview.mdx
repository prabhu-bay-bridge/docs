...
When you register a new customer with Bridge, they must agree to our terms of service, and we must collect key information such as name and email, along with unique identifiers such as SSN or EIN/TIN. Please see [full KYC Requirements](https://apidocs.bridge.xyz/docs/individuals) [todo update link] for details. This information allows Bridge to properly KYC/KYB and approve the customer before initiating any transactions with Bridge. If and when needed, we will further pass you precise details on what additional information we need from your users to complete KYC/KYB.

Alternatively, you can use [Terms of Service API](doc:terms-of-service) [todo update link] to allow your customers to (re)accept Bridge's terms of service (ToS) without attempting KYC/KYB.
