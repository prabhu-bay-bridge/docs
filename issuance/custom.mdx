...
When you or your end users want to swap in and out of xUSD we just use our orchestration API endpoints. We support all the same routes as [<u>Transfers</u>](/orchestration/transfer/transfer)<u>,</u> [<u>Liquidation Addresses</u>](/orchestration/liquidation_address/liquidation_address), and [<u>Virtual Accounts</u>](/guides/movemoney/virtualaccounts).
