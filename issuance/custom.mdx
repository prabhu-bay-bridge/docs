...
When you or your end users want to swap in and out of xUSD we just use our orchestration API endpoints. We support all the same routes as [<u>Transfers</u>](https://apidocs.bridge.xyz/docs/transfers-1) [<u>Liquidation Addresses</u>](https://apidocs.bridge.xyz/docs/liquidation-address) and [<u>Virtual Accounts</u>](https://apidocs.bridge.xyz/docs/virtual-accounts).
