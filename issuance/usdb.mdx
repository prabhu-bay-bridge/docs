...
When you or your end users want to swap in and out of USDB we just use our orchestration API endpoints: [Transfers](/orchestration/transfer/transfer), [Virtual Accounts](/guides/movemoney/virtualaccounts), and [Liquidation Addresses](/orchestration/liquidation_address/liquidation_address).

# **Interacting with USDB**

## **Swapping to USDB**

To swap from fiat or other stablecoins to USDB, you can use the [Transfers](/orchestration/transfer/transfer) API.
