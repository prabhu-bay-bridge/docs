...
| **Field**        | **Description**                                                                                                                                                                                           |
| :--------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `sepa reference` | Freeform message provided by the sender. Strongly recommended to use a UUID for automated matching.<br /><br />⚠️ When initiating SEPA payouts with Bridge, always include a UUID in the reference field. |
