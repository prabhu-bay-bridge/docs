...
For new customer creations, use this endpoint to request a URL and reference our [<u>ToS Links API</u>](/api-reference/customers/request-a-hosted-url-for-tos-acceptance-for-new-customer-creation)
...
Please reference our [<u>ToS Acceptance Link API</u>](/api-reference/customers/retrieve-a-hosted-url-for-tos-acceptance-for-an-existing-customer) for existing customers for more details.