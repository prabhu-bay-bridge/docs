...
For other customers intending to use these services, please refer to [ToS Acceptance of a New Version](/customers/tos) and [KYC Link for Existing Customers](/customers/kyclinks) for details on how to obtain links to complete the `ToS V2 Acceptance` and, if necessary, `KYC Proof-of-Address` processes. Utility bills and bank statements are recommended for proof of address.
