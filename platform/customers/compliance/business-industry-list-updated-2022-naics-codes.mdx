---
title: "Business Industry List Updated (2022 NAICS Codes)"
---

This page enumerates the valid list of updated industry (NAICS 2022) codes, accepted when submitting the `business_industry` field to our customer APIs. All codes should be passed as string values.
