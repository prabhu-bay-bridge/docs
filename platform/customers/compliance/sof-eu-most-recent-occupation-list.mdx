---
title: "Source of Funds - Expected Use (SoF-Eu) Most Recent Occupation List"
---

This page enumerates the valid job-codes for submitting individual SoF-Eu questionnaires via API. All codes should be passed as string values.
