...
<Warning>
  **Do not send tokens directly to this address.** You can use a [<u>Liquidation Address</u>](/platform/orchestration/liquidation_address/liquidation_address) and point it to a wallet endpoint for incoming funds.
</Warning>
