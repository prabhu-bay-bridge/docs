...
To do so, you should use the [Create Card PIN Update URL](/api-reference/cards/create-card-pin-update-url) API to request a signed URL which your user can use to kick off a PIN editing session.
