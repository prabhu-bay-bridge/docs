...
Before issuing a card, you must first onboard a customer. Learn more at [<u>Create your first customer</u>](/get-started/introduction/quick-start/create-your-first-customer).
