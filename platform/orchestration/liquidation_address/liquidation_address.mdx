...
[Setting a custom developer fee](/platform/orchestration/fees-and-mins/devfees) overrides the default Liquidation Address developer fee for a given Liquidation Address upon creation.
