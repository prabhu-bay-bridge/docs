...
Fees are settled and **paid out monthly** on the 5th of each month to your configured external account. You can use the [Configure a fee External Account](/platform/orchestration/external-accounts/external-accounts-api) API to configure the external account you want to get paid out in.
