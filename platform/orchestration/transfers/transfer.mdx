...
- [Stablecoins and Blockchains](/get-started/introduction/what-we-support/blockchains)
- [Fiat Payment Methods](/get-started/introduction/what-we-support/fiat)
...
- `developer_fee` or `developer_fee_percent`: Monetize transfers via fixed or percentage fees. Refer the [Developer Fees](/platform/orchestration/fees-and-mins/devfees) section on how to set fees.
...
If you receive crypto deposits, remember to configure a crypto return policy\! Refer [Crypto Return Policies](/platform/orchestration/transfer/returns#returning-crypto-deposits)
