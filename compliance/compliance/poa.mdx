...
Note: [<u>DAOs</u>](https://apidocs.bridge.xyz/docs/daos) may provide proof of physical residential address for their verified control person if the DAO does not have its own physical operating address.
